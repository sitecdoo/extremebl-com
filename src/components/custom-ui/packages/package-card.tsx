...
const PackageCard = ({ name, price, offers }: PackageCardProps) => {
  return (
    <div className="flex w-80 min-w-60 max-w-80 flex-col gap-y-8 rounded-20 bg-neutrals-100 px-12 py-8 shadow-sm lg:w-[22.5rem] lg:max-w-[22.5rem] lg:gap-y-12 lg:px-14 lg:py-12">
